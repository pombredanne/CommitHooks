...
class CommitMessage:
    ...
    def do_not_closed_check(self):
        self.validators.append(NotClosedValidator())
...
class GusHelper:
    '''
    Helper class that finds work in GUS that is associated to the current user and displays it.
    '''
